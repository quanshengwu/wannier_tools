...
! loop index  
     integer :: i1,i2,ia,ib,iR, ia1, ia2
    ...
    !Hamk_bulk= (Hamk_bulk+ mat2)/2d0
     ...
     do i2=1, Num_wann
        if(abs(Hamk_bulk(i1,i2)-conjg(Hamk_bulk(i2,i1))).ge.1e-6)then
          write(stdout,*)'Hamk_bulk is not hermitian'
          write(stdout,*)i1, i2, Hamk_bulk(i1,i2), Hamk_bulk(i2,i1) 
          stop
        endif 
     enddo
     enddo
