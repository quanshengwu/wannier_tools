...
!> nvfortran -cuda -cudalib=cusparse,cublas,cusolver -Mpreprocess -C -traceback -c cuda_blas.F90
...
! ! compile it with
! !> nvfortran -cuda -cudalib=cusparse -Mpreprocess -C -traceback cusparse_blas.F90
! ! run it with 
! !  ./a.out
